    ...
    try {
      ...
      if (autenticado) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Biometria autenticada com sucesso!')),
        );
      } else {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Biometria nao reconhecida.')),
        );
      }
    } catch (erro) {
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Erro ao autenticar com biometria.')),
      );
    }
  }
